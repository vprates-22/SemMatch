...
from SemMatch.report.server import runReport
...
if __name__ == "__main__":
    ...
    semMatch = SemanticEval({
        ...
        'data_path': 'scannet_test_1500',
        'max_pairs': 15
    })

    matches, results = semMatch.extract_and_save_matches(match_fn, 'test')

    runReport({
        'sam_model': 'sam2.1_l.pt',
        'matches_file_path': matches,
